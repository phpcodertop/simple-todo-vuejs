...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    VueSimpleSpinner: vue_simple_spinner__WEBPACK_IMPORTED_MODULE_1___default.a
  },
  ...
  methods: {
    deleteTodo: function deleteTodo(id) {
      this.allTasks = this.allTasks.filter(function (e) {
        return e.id !== id;
      });
    },
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    toggleStatus: function toggleStatus(id) {
      ...
      axios.put('/tasks/' + id).then(function (response) {
        var status = _this2.tasks.find(function (task) {
          return task.id === id;
        }).status;
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "div",
        { staticClass: "col-md-4 col-md-offset-4 col-xs-6 col-xs-offset-3" },
        [
          _c("div", { staticClass: "add-control" }, [
            _c(
              "form",
              {
                on: {
              ...
              [
                _c("div", { staticClass: "form-group has-feedback" }, [
                  _c("input", {
                    ...
                    attrs: { type: "text", placeholder: "✍️ Add item..." },
                  ...
                  _vm._v(" "),
                  _c("i", {
                    staticClass: "fa fa-plus form-control-feedback add-btn",
          ...
          _vm._v(" "),
          _vm.isLoading ? _c("vue-simple-spinner") : _vm._e(),
          _vm._v(" "),
          _c("todo-list", {
            attrs: { tasks: _vm.allTasks },
            on: { todoDelete: _vm.deleteTodo }
          })
        ],
        1
      )
        ...
        [
          _c("div", { staticClass: "checkbox" }, [
            ...
            _c(
              ...
              [
                _c("span", { staticClass: "checkbox-mask" }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_AllTasks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/AllTasks */ "./resources/js/components/AllTasks.vue");
...
var app = new Vue({
  el: '#app',
  components: {
    AllTasks: _components_AllTasks__WEBPACK_IMPORTED_MODULE_0__["default"]
  }
});
...
__webpack_require__(/*! C:\laragon\www\VueTodo\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\laragon\www\VueTodo\resources\css\app.scss */"./resources/css/app.scss");
